...
expi = 3
expf = 9
[errores orden]=ejercicio1_inciso2_auxiliar(f,a,b,ya,expi,expf,sol)
[erroresHeun erroresRk4]=ejercicio1_inciso2_auxiliarOrdenes(f,a,b,ya,expi,expf,sol)
...
title('Errores globales segun el valor de h');
ylabel('E');
xlabel('h');
